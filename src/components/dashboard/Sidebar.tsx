  ...
  return (
    <aside className="hidden w-[240px] shrink-0 flex-col border-r border-border bg-card lg:flex">
      <div className="flex items-center gap-2 px-5 py-5">
          <LogoMark size={30} />
        <span className="text-[16px] font-black tracking-tight text-foreground">aplyer.ai</span>
      </div>

      <nav className="flex-1 px-3 py-2">
        <div className="px-2 pb-2 font-mono text-[11px] uppercase tracking-[0.18em] text-muted-foreground">
          Workspace
        </div>
        {nav.map((item) => {
      ...
      <div className="border-t border-border p-3">
        <button
          ...
          className="mb-2 flex w-full items-center gap-2 rounded-lg border border-brand-green/25 bg-brand-green/5 px-3 py-2.5 text-[14px] text-brand-green hover:bg-brand-green/10"
        >
        ...
        <button
          onClick={signOut}
          className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-[14px] text-muted-foreground hover:bg-field hover:text-foreground"
        >
