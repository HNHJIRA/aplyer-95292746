    ...
    <div className="relative flex h-full flex-col">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-7 pt-4 text-center">
        ...
        <motion.div
          ...
          className="mt-6 inline-flex items-center gap-1.5 rounded-full border border-brand-green/25 bg-brand-green/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-brand-green"
        >
        ...
        <motion.p
          ...
          className="mt-3 text-[14px] leading-relaxed text-sub"
        >
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 font-mono text-[10px] uppercase tracking-[0.16em] text-muted-foreground">
