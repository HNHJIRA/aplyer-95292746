  ...
  return (
    <div className="relative flex h-full flex-col">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-7 text-center">
        ...
        <div className="mt-5 inline-flex items-center gap-1.5 rounded-full border border-brand-green/25 bg-brand-green/10 px-3 py-1 font-mono text-[12px] uppercase tracking-[0.18em] text-brand-green">
