...
function SubscriptionPage() {
  ...
  return (
    <div className="space-y-5">
        ...
        {PLANS.map((p) => {
          ...
          return (
            ...
            >
              ...
              <div className="font-mono text-[12px] uppercase tracking-[0.18em] text-muted-foreground">{p.name}</div>
      ...
      <p className="text-center text-[13px] text-muted-foreground">Billing powered by Stripe.</p>
    </div>
  );
}
